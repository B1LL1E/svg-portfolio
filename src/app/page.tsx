    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl mx-auto ">
        {projects.map((project) => (
          ...
          className="group relative aspect-video bg-neutral-900 border border-neutral-800 flex items-center justify-center cursor-pointer overflow-hidden transition-all hover:border-white/50">
